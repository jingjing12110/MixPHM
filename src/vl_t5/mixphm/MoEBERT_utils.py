...
class ImportanceProcessor:
    def __init__(self, config, layer_idx, num_local_experts, local_group_rank):
        ...
        importance = ImportanceProcessor.load_importance_single(
            config.moebert_load_importance)[layer_idx, :]
    ...
    def _split_importance(self, arr):
        ...
        for i in range(self.num_local_experts):
            temp = all_experts_remain[
                self.num_local_experts * self.local_group_rank + i]
